...
<p><i>The animated map below comprises ≥2.4 million pixels (1 pixel = 20 km<sup>2</sup>) generated from the combined neural network and random forest DMS predictions over the 7 month climatology </i></p>
</div>
<p>&nbsp;  </p>
<div>
<p float="left">
