...
<p><i>The map below comprises over 2.4 million pixels (1 pixel = 20 km<sup>2</sup>) generated from the combined neural network and random forest predictions for the 7 month climatology: &cudarrr;</i></p>
</div>
<div>
<p float="left">
